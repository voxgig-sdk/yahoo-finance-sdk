...
class DownloadEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YAHOOFINANCE_TEST_DOWNLOAD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function download_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YAHOOFINANCE_TEST_DOWNLOAD_ENTID");
