...
// YahooFinance SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YahooFinanceSDK::test)
...
{
    private const SDK_CLASS = 'YahooFinanceSDK';
    ...
    private const SDK_BASE = 'yahoofinance_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yahoofinance_sdk.php';
