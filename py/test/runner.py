...
class YahooFinanceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YahooFinanceTestRunner.getenv("YAHOOFINANCE_TEST_LIVE")
        override = YahooFinanceTestRunner.getenv("YAHOOFINANCE_TEST_OVERRIDE")
        ...
        explain = YahooFinanceTestRunner.getenv("YAHOOFINANCE_TEST_EXPLAIN")
