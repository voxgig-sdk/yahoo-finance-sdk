...
AQL-driven CLI and REPL for the YahooFinance SDK. Positional arguments are
...
./yahoo-finance-cli list download
./yahoo-finance-cli load 1 download
./yahoo-finance-cli load '{id:1}' download
