...
// YahooFinance SDK utility: make_options

class YahooFinanceMakeOptions
{
    ...
    public static function call(YahooFinanceContext $ctx): array
    {
        ...
        //
        // `YahooFinanceSchema::optspec()` is built from the model:
        ...
        $optspec = YahooFinanceSchema::optspec();
