...
// YahooFinance SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class YahooFinanceTransformResponse
{
    public static function call(YahooFinanceContext $ctx): mixed
    {
        ...
        $transform = YahooFinanceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
