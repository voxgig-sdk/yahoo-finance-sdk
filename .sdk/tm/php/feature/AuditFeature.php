...
// YahooFinance SDK audit feature
...
class YahooFinanceAuditFeature extends YahooFinanceBaseFeature
{
    ...
    private function _emit(YahooFinanceContext $ctx, string $outcome): void
    {
