...
class MarketEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YAHOO_FINANCE_TEST_MARKET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function market_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YAHOO_FINANCE_TEST_MARKET_ENTID");
