// Command YahooFinance-mcp is an MCP server exposing the YahooFinance
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YahooFinance_list  — list records of an entity
//	YahooFinance_load  — load a single record of an entity
//
