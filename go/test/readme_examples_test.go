...
const testSeed = `map[string]any{"entity": map[string]any{"download": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "market": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "screener": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticker": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
