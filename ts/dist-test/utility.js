...
function envOverride(m) {
    if ('TRUE' === process.env.YAHOO_FINANCE_TEST_LIVE ||
        'TRUE' === process.env.YAHOO_FINANCE_TEST_OVERRIDE) {
    ...
    m.YAHOO_FINANCE_TEST_EXPLAIN = process.env.YAHOO_FINANCE_TEST_EXPLAIN || m.YAHOO_FINANCE_TEST_EXPLAIN;
    return m;
}
