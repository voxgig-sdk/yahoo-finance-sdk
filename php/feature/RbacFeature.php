...
class YahooFinanceRbacFeature extends YahooFinanceBaseFeature
{
    ...
    private function _required(YahooFinanceContext $ctx): ?string
    {
    ...
    private function _reject(YahooFinanceContext $ctx, string $required): void
    {
    ...
    private function _track(YahooFinanceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
