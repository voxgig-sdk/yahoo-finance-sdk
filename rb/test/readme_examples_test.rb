...
#      offline in seeded test mode (YahooFinanceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YahooFinance_sdk.rb")
  SDK_CLASS = "YahooFinanceSDK"
