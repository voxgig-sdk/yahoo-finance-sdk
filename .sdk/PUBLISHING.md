...
|---|---|---|
| `ts/` | @voxgig-sdk/yahoo-finance-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yahoo-finance-sdk \
      --repository voxgig-sdk/yahoo-finance-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yahoo-finance-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yahoo-finance-sdk --id=<id>` removes it.
