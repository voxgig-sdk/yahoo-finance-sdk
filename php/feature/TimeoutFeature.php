...
// YahooFinance SDK timeout feature
...
class YahooFinanceTimeoutFeature extends YahooFinanceBaseFeature
{
    ...
    private function _with_timeout(YahooFinanceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YahooFinanceContext $_ctx, float $ms): void
    {
        $client = $this->client;
