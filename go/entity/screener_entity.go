...
type ScreenerEntity struct {
	name    string
	client  *core.YahooFinanceSDK
...
func NewScreenerEntity(client *core.YahooFinanceSDK, entopts map[string]any) *ScreenerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScreenerEntity) GetName() string { return e.name }
...
func (e *ScreenerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScreenerEntity) Deleted() bool {
	return e.deleted
}


func (e *ScreenerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScreenerEntity(e.client, opts)
}

func (e *ScreenerEntity) Data(args ...any) any {
...
func (e *ScreenerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Screener; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScreenerEntity) DataTyped(data ...Screener) Screener {
	if len(data) > 0 {
		return typedFrom[Screener](e.Data(asMap(data[0])))
	}
	return typedFrom[Screener](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Screener (all fields
// optional at the wire level).
func (e *ScreenerEntity) MatchTyped(match ...Screener) Screener {
	if len(match) > 0 {
		return typedFrom[Screener](e.Match(asMap(match[0])))
	}
	return typedFrom[Screener](e.Match())
}
...
func (e *ScreenerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScreenerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ScreenerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ScreenerEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScreenerCreateData and returns an Screener. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ScreenerEntity) CreateTyped(reqdata ScreenerCreateData, ctrl map[string]any) (Screener, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Screener{}, err
	}
	return typedFrom[Screener](res), nil
}



func (e *ScreenerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScreenerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScreenerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
