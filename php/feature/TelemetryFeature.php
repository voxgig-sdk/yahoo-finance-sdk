...
// YahooFinance SDK telemetry feature
...
class YahooFinanceTelemetryFeature extends YahooFinanceBaseFeature
{
    ...
    private function _close(YahooFinanceContext $ctx, bool $ok): void
    {
