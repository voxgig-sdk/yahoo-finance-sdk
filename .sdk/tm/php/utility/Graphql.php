...
// YahooFinance SDK utility: graphql
//
...
class YahooFinanceGraphql
{
    ...
    // equivalent.
    public static function body(YahooFinanceContext $ctx): mixed
    {
    ...
    public static function errors(YahooFinanceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
