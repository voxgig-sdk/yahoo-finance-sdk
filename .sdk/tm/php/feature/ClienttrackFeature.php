...
// YahooFinance SDK clienttrack feature
...
class YahooFinanceClienttrackFeature extends YahooFinanceBaseFeature
{
    ...
    public function PostConstruct(YahooFinanceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YahooFinance-SDK';
