...
// YahooFinance SDK cache feature
...
class YahooFinanceCacheFeature extends YahooFinanceBaseFeature
{
    ...
    private function _through(YahooFinanceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
