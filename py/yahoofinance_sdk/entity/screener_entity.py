...
from yahoofinance_sdk.yahoofinance_types import (
    Screener,
    ScreenerCreateData,
)
...
class ScreenerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ScreenerEntity(self._client, opts)
    ...
    def create(self, reqdata: ScreenerCreateData, ctrl=None) -> Screener:
        utility = self._utility
