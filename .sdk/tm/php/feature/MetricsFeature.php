...
// YahooFinance SDK metrics feature
...
class YahooFinanceMetricsFeature extends YahooFinanceBaseFeature
{
    ...
    private function _record(YahooFinanceContext $ctx, bool $ok): void
    {
