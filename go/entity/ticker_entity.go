...
func NewTickerEntity(client *core.YahooFinanceSDK, entopts map[string]any) *TickerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TickerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
