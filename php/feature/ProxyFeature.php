...
// YahooFinance SDK proxy feature
...
class YahooFinanceProxyFeature extends YahooFinanceBaseFeature
{
    ...
    public function init(YahooFinanceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YahooFinanceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
