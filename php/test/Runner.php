...
class YahooFinanceTestRunner
{
    ...
    {
        $live = self::getenv('YAHOO_FINANCE_TEST_LIVE');
        $override = self::getenv('YAHOO_FINANCE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('YAHOO_FINANCE_TEST_EXPLAIN');
...
class_alias('YahooFinanceTestRunner', 'Runner');
class_alias('YahooFinanceHelpers', 'Helpers');
