...
// YahooFinance SDK streaming feature
...
class YahooFinanceStreamingFeature extends YahooFinanceBaseFeature
{
    ...
    private function _iterate(YahooFinanceResult $result): \Generator
    {
    ...
    private function _streamable(YahooFinanceContext $ctx): bool
    {
