...
// YahooFinance SDK ratelimit feature
...
class YahooFinanceRatelimitFeature extends YahooFinanceBaseFeature
{
    ...
    private function _acquire(YahooFinanceContext $ctx): void
    {
    ...
    private function _track(YahooFinanceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
