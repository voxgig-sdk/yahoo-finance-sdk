...
local SDK_MODULE = "yahoo-finance_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["download"] = { ["test01"] = { id = "test01" } }, ["market"] = { ["test01"] = { id = "test01" } }, ["screener"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["ticker"] = { ["test01"] = { id = "test01" } } } }'
