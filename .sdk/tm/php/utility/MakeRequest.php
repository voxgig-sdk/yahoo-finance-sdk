...
// YahooFinance SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YahooFinanceMakeRequest
{
    public static function call(YahooFinanceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YahooFinanceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YahooFinanceResponse($fetched);
        } else {
