...
// YahooFinance SDK utility: fetcher
...
class YahooFinanceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YahooFinanceSDK/1.0)';
    ...
    public static function call(YahooFinanceContext $ctx, string $fullurl, array $fetchdef): array
    {
