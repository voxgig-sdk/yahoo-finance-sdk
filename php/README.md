...
The PHP SDK for the YahooFinance API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Download(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->YahooFinance(null)->load(
    ["id" => "test01"], null
);
