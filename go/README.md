...
## Install
```bash
go get github.com/voxgig-sdk/yahoo-finance-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/yahoo-finance-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/yahoo-finance-sdk/go=../yahoo-finance-sdk/go
```
...
fmt.Println(market) // the loaded record
```
...
```
github.com/voxgig-sdk/yahoo-finance-sdk/go/
...
The root package (`github.com/voxgig-sdk/yahoo-finance-sdk/go`) re-exports everything needed
