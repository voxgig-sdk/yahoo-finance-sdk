...
// YahooFinance SDK Market entity
...
class MarketEntity
{
     ...
     *
     * @param MarketLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MarketLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Market|array The loaded Market as an assoc-array at the
