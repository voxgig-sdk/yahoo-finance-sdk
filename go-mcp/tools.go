...
type Args struct {
	Entity string         `json:"entity" jsonschema:"download | market | screener | search | ticker"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.YahooFinanceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yahoo-finance_list",
		Description: "List records from YahooFinance. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yahoo-finance_load",
		Description: "Load a single record from YahooFinance. " +
...
func runOp(client *sdk.YahooFinanceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YahooFinanceSDK, name string) (sdk.YahooFinanceEntity, error) {
	...
	case "screener":
		return client.Screener(nil), nil
	case "search":
