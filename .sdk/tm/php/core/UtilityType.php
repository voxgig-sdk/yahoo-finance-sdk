...
// YahooFinance SDK utility type

class YahooFinanceUtility
{
    ...
    public static function copy(YahooFinanceUtility $src): YahooFinanceUtility
    {
        $u = new YahooFinanceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
