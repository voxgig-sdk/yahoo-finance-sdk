...
// YahooFinance SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YahooFinanceOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YahooFinanceOmni::structfix($now, Struct::undef()))
                        !== json_encode(YahooFinanceOmni::structfix($val, Struct::undef()))) {
