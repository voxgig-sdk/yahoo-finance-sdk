# YahooFinance SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YahooFinanceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YahooFinanceSDK(...) and YahooFinanceSDK.test(...) become
#      YahooFinanceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yahoofinance_sdk"
_SDK_CLASS = "YahooFinanceSDK"
