...
class TickerEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set YAHOOFINANCE_TEST_TICKER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ticker_basic_setup(extra)
  ...
  entid_env_raw = ENV["YAHOOFINANCE_TEST_TICKER_ENTID"]
