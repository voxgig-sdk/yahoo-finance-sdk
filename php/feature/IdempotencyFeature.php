...
// YahooFinance SDK idempotency feature
...
class YahooFinanceIdempotencyFeature extends YahooFinanceBaseFeature
{
    ...
    private function _mutating(YahooFinanceContext $ctx): bool
    {
