...
describe("MarketDirect", function()
  it("should direct-load-market", function()
    local setup = market_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-market", setup.live and "live" or "unit")
