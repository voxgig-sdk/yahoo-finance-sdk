...
from yahoofinance_sdk.utility import register

# Load features
from yahoofinance_sdk.feature.base_feature import YahooFinanceBaseFeature
from yahoofinance_sdk.features import _make_feature
...
class YahooFinanceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = YahooFinanceUtility()
        self._utility = utility

        from yahoofinance_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return YahooFinanceUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "YahooFinanceSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YahooFinanceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Download(self, data=None) -> "DownloadEntity":
        ...
        from yahoofinance_sdk.entity.download_entity import DownloadEntity
    ...
    def Market(self, data=None) -> "MarketEntity":
        ...
        from yahoofinance_sdk.entity.market_entity import MarketEntity
    ...
    def Screener(self, data=None) -> "ScreenerEntity":
        ...
        from yahoofinance_sdk.entity.screener_entity import ScreenerEntity
        return ScreenerEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from yahoofinance_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)


    def Ticker(self, data=None) -> "TickerEntity":
        """Entity factory: client.Ticker().list() / client.Ticker().load({"id": ...})."""
        from yahoofinance_sdk.entity.ticker_entity import TickerEntity
