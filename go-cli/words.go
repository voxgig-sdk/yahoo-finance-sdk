...
func registerSDKWords(r *eng.Registry, client *sdk.YahooFinanceSDK) {
...
func runOp(client *sdk.YahooFinanceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
