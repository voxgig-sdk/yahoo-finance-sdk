...
class TickerEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set YAHOOFINANCE_TEST_TICKER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ticker_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("YAHOOFINANCE_TEST_TICKER_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["YAHOOFINANCE_TEST_TICKER_ENTID"]);
