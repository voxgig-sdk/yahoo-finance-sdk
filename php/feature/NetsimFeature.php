...
// YahooFinance SDK netsim feature
...
class YahooFinanceNetsimFeature extends YahooFinanceBaseFeature
{
    ...
    private function _simulate(YahooFinanceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YahooFinanceContext $ctx, array $applied): void
    {
        $client = $this->client;
